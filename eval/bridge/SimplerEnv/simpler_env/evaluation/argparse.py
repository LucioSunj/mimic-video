...
def get_args():
    ...
    parser.add_argument("--vam-experiment-name", type=str, required=True)
    parser.add_argument("--vam-video-model-path", type=str, required=True)
    parser.add_argument("--vam-action-model-path", type=str, required=True)
    parser.add_argument("--vam-dataset-statistics-path", type=pathlib.Path, required=True)
    parser.add_argument("--vam-img-horizon", type=int, required=True)
